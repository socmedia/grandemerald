...
@section('content')
<!-- Pool Section -->
<section class="pool overlay-bottom rellax" data-rellax-speed="-5">
    <div class="container-fluid">
        <div class="card-body title">
            <h3 class="title-text rellax" data-rellax-speed="1.3">My Home My Sanctuary</h3>
            <p class="description rellax" data-rellax-speed="1.3">
                Kembali ke alam telah menjadi mimpi yang hadir di benak setiap generasi sejak manusia
                pertama kali meninggalkan alam.
            </p>
        </div>
    </div>
</section>
