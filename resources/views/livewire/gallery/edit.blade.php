            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <form wire:submit.prevent="editMedia">
                                ...
                                <div class="form-group text-center">
                                    <img class="w-75 rounded" src="{{$media ? $media->temporaryUrl() : $oldMedia}}"
                                        alt="">
                                </div>
                                ...
                                <div class="form-group text-center">
                                    <video class="w-100" controls preload="auto" loading="lazy"
                                        poster="{{$thumbnail ? $thumbnail->temporaryUrl() : $oldThumbnail}}"
                                        data-setup="{}">
                                        <source src="{{$media ? $media->temporaryUrl() : $oldMedia}}"
                                            type="video/mp4" />
                                    </video>
                                </div>
