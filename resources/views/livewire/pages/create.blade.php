                            ...
                            <form wire:submit.prevent="savePage" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-2 col-md-2 mb-3 mb-md-0">
                                        ...
                                        <div class="form-control bg-light">{{ $order }}</div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <input type="text" class="form-control" wire:model.defer="title_normal"
                                            id="title_normal">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" wire:model.defer="title_secondary"
                                            id="title_secondary">
